...
const createInnerHtml = () => {
    ...
    for(let addressData of addressBookList) {
        ...
        <td>
            <img id="${addressData._id}" src="../assets/delete-black-18dp.svg" alt="Delete" onclick="remove(this)">
            <img id="${addressData._id}" src="../assets/create-black-18dp.svg" alt="Edit" onclick="update(this)">
        </td>
    </tr>`;
